   ...
   <div className="container max-w-screen-lg mt-5">
     ...
     <Tabs defaultValue={currentTab}>
       ...
       <TabsContent value="gallery">
         <h2 className="text-center text-2xl font-semibold mt-10">Gallery {title}</h2>
       </TabsContent>

       <TabsContent value="messages">
         <h2 className="text-center text-2xl font-semibold mt-10">Messages {title}</h2>
       </TabsContent>

       <TabsContent value="settings">
         <h2 className="text-center text-2xl font-semibold mt-10">Settings {title}</h2>
       </TabsContent>
     </Tabs>
   </div>
  );
